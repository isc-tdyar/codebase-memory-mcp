...
static CBMFileResult *extract_c(const char *src) {
    return cbm_extract_file(src, (int)strlen(src), CBM_LANG_C, "test", "main.c", 0, NULL, NULL, NULL, NULL);
}

static CBMFileResult *extract_cpp(const char *src) {
    return cbm_extract_file(src, (int)strlen(src), CBM_LANG_CPP, "test", "main.cpp", 0, NULL, NULL, NULL, NULL);
}
...
TEST(clsp_nocrash_issue355_xxhash_header) {
    ...
    buf[rd] = '\0';
    CBMFileResult *r =
        cbm_extract_file(buf, (int)rd, CBM_LANG_C, "test", "xxhash.h", 0, NULL, NULL, NULL, NULL);
    ASSERT_NOT_NULL(r);
    cbm_free_result(r);
    free(buf);
    PASS();
...
TEST(clsp_nocrash_empty_source) {
    CBMFileResult *r = cbm_extract_file("", 0, CBM_LANG_CPP, "test", "main.cpp", 0, NULL, NULL, NULL, NULL);
    ASSERT_NOT_NULL(r);
    cbm_free_result(r);
    PASS();
}
