...
// ObjectScript type map: variable name → class name (for instance_method_call resolution).
// Stack-allocated, per-method scope. Overflow is silent (no crash).
